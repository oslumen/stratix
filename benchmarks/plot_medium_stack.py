"""
Medium-stack sweep benchmark
=============================

Three alternating films with a 50×50 wavelength–kx sweep.  The extra
layers exercise the S-matrix and recurrence solves more thoroughly than
...
bar_chart_compare(
    ...
    backends,
    title="Backend comparison — SMATRIX, 3-film 50×50 sweep",
    ylabel="Solve time (s)",
)
...
bar_chart_compare(
    ...
    method_names,
    title="Method comparison — NumPy backend, 3-film 50×50 sweep",
    ylabel="Solve time (s)",
)
...
heatmap(
    ...
    col_labels=backends,
    title="Method × backend solve time (s) — 3-film 50×50 sweep",
)
...
if jit_backends:
    ...
    bar_chart_compare(
        ...
        jit_backends,
        title="JIT steady-state — SMATRIX, 3-film 50×50 sweep",
        ylabel="Solve time (s)",
    )
else:
...
if nd.HAS_CUDA:
    ...
    bar_chart_compare(
        ...
        gpu_backends,
        title="GPU vs CPU — SMATRIX, 3-film 50×50 sweep",
        ylabel="Solve time (s)",
    )
else:
    print(
