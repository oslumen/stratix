...
.. "benchmarks/plot_medium_stack.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_benchmarks_plot_medium_stack.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_benchmarks_plot_medium_stack.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /benchmarks/images/sphx_glr_plot_medium_stack_001.png
         :alt: Backend comparison — SMATRIX, 3-film 50×50 sweep
         :srcset: /benchmarks/images/sphx_glr_plot_medium_stack_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /benchmarks/images/sphx_glr_plot_medium_stack_002.png
         :alt: plot medium stack
         :srcset: /benchmarks/images/sphx_glr_plot_medium_stack_002.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /benchmarks/images/sphx_glr_plot_medium_stack_003.png
         :alt: Method comparison — NumPy backend, 3-film 50×50 sweep
         :srcset: /benchmarks/images/sphx_glr_plot_medium_stack_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /benchmarks/images/sphx_glr_plot_medium_stack_004.png
         :alt: plot medium stack
         :srcset: /benchmarks/images/sphx_glr_plot_medium_stack_004.png
         :class: sphx-glr-multi-img
...
.. image-sg:: /benchmarks/images/sphx_glr_plot_medium_stack_005.png
   :alt: Method × backend solve time (s) — 3-film 50×50 sweep
   :srcset: /benchmarks/images/sphx_glr_plot_medium_stack_005.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (<Figure size 600x480 with 2 Axes>, <Axes: title={'center': 'Method × backend solve time (s) — 3-film 50×50 sweep'}>)
...
.. GENERATED FROM PYTHON SOURCE LINES 134-159
...
.. image-sg:: /benchmarks/images/sphx_glr_plot_medium_stack_006.png
   :alt: JIT steady-state — SMATRIX, 3-film 50×50 sweep
   :srcset: /benchmarks/images/sphx_glr_plot_medium_stack_006.png
   :class: sphx-glr-single-img
...
.. image-sg:: /benchmarks/images/sphx_glr_plot_medium_stack_007.png
   :alt: GPU vs CPU — SMATRIX, 3-film 50×50 sweep
   :srcset: /benchmarks/images/sphx_glr_plot_medium_stack_007.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    R — stratix: 0.00000000  tmm: 0.00000000  err: 2.41e-13
    T — stratix: 1.00000000  tmm: 1.00000000  err: 1.11e-15
...
.. _sphx_glr_download_benchmarks_plot_medium_stack.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_medium_stack.ipynb <plot_medium_stack.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_medium_stack.py <plot_medium_stack.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_medium_stack.zip <plot_medium_stack.zip>`
