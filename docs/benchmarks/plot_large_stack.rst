...
.. "benchmarks/plot_large_stack.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_benchmarks_plot_large_stack.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_benchmarks_plot_large_stack.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /benchmarks/images/sphx_glr_plot_large_stack_001.png
         :alt: Backend comparison — SMATRIX, 8-film 50×50 sweep
         :srcset: /benchmarks/images/sphx_glr_plot_large_stack_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /benchmarks/images/sphx_glr_plot_large_stack_002.png
         :alt: plot large stack
         :srcset: /benchmarks/images/sphx_glr_plot_large_stack_002.png
         :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /benchmarks/images/sphx_glr_plot_large_stack_003.png
         :alt: Method comparison — NumPy backend, 8-film 50×50 sweep
         :srcset: /benchmarks/images/sphx_glr_plot_large_stack_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /benchmarks/images/sphx_glr_plot_large_stack_004.png
         :alt: plot large stack
         :srcset: /benchmarks/images/sphx_glr_plot_large_stack_004.png
         :class: sphx-glr-multi-img
...
.. image-sg:: /benchmarks/images/sphx_glr_plot_large_stack_005.png
   :alt: Method × backend solve time (s) — 8-film 50×50 sweep
   :srcset: /benchmarks/images/sphx_glr_plot_large_stack_005.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    (<Figure size 600x480 with 2 Axes>, <Axes: title={'center': 'Method × backend solve time (s) — 8-film 50×50 sweep'}>)
...
.. image-sg:: /benchmarks/images/sphx_glr_plot_large_stack_006.png
   :alt: JIT steady-state — SMATRIX, 8-film 50×50 sweep
   :srcset: /benchmarks/images/sphx_glr_plot_large_stack_006.png
   :class: sphx-glr-single-img
...
.. image-sg:: /benchmarks/images/sphx_glr_plot_large_stack_007.png
   :alt: GPU vs CPU — SMATRIX, 8-film 50×50 sweep
   :srcset: /benchmarks/images/sphx_glr_plot_large_stack_007.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    R — stratix: 0.69067862  tmm: 0.69067862  err: 2.89e-15
    T — stratix: 0.30932138  tmm: 0.30932138  err: 3.41e-15
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 12.543 seconds)

**Estimated memory usage:**  84 MB


.. _sphx_glr_download_benchmarks_plot_large_stack.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_large_stack.ipynb <plot_large_stack.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_large_stack.py <plot_large_stack.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_large_stack.zip <plot_large_stack.zip>`
